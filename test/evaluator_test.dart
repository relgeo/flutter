    ...
    test('Fungsi v0.5 geometry dan string minimum', () {
      final context = SimpleEvalContext(
        ...
        objects: {
          ...
          'mirrorCenter': ResolvedPoint(id: 'mirrorCenter', meta: Meta(), x: 4, y: 1),
          'guideLine': ResolvedLine(id: 'guideLine', meta: Meta(), x1: 0, y1: 0, x2: 10, y2: 0),
          'rect1': ResolvedRect(id: 'rect1', meta: Meta(), x: 10, y: 20, width: 30, height: 40),
          'ellipse1': ResolvedEllipse(id: 'ellipse1', meta: Meta(), cx: 20, cy: 30, rx: 10, ry: 5, rotation: 0),
      ...
      expect(evaluator.evaluate('angleBetween(A, B)'), closeTo(0.78539816339, 1e-6));
      ...
      expect(evaluator.evaluate('project(localPt, guideLine)'), (x: 2.0, y: 0.0));
      expect(evaluator.evaluate('reflect(localPt, mirrorCenter)'), (x: 6.0, y: -1.0));
      expect(evaluator.evaluate('reflect(localPt, guideLine)'), (x: 2.0, y: -3.0));
      expect(evaluator.evaluate('perimeter(closedPath)'), 40.0);
      expect(evaluator.evaluate('concat("Part-", prefix, "-", count)'), 'Part-A-5.0');
